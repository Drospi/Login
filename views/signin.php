...
<body>
  ...
  <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Registrate gratis</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">Puedes poner los datos que quieras, pero nombre, email y password son necesarias.</p>
    </div>
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2 flex items-center gap-x-3">
            ...
            <label for="file-profile-upload" class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Change
              <input name="file-profile-upload" id="file-profile-upload" type="file" accept="image/jpg" class="sr-only">
            </label>
